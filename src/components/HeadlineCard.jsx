    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
        ...
        <div className='relative rounded-xl'>
            ...
            '>
                ...
                <button className='border border-white rounded-xl px-5 py-1 text-black bg-white ml-2 mt-4'>Order Now</button>
            </div>
        ...
        <div className='relative rounded-xl'>
            ...
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white
            '>
                <p className='font-bold text-2xl px-2 pt-10'>We Deliver Desserts Too</p>
