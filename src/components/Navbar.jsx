...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        <button className='border border-black rounded-full px-5 hidden md:flex items-center py-2 bg-black text-white'>
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen z-10 bg-white duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
